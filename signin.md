...
<img src="images/htrc-dropdown-option.png" alt="Sign in window showing the ‘HTRC’ option selected in the dropdown" width="600"/>

3. Enter your HTRC local account username and password on the sign in page.
<img src="images/htrc-local-account-signin-page.png" alt="Local account sign in page with username and password entered" width="600"/>

4. Select the sign in button and you will now be signed into your TORCHLITE account.
<img src="images/signed-in-account.png" alt="Right-hand corner of dashboard showing user’s account name to indicate being logged in
" width="600" />
