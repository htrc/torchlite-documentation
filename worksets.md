...
<img src="images/side-menu-open-button.png" alt="red arrow pointing to side menu button" width="300"/>

2. Select the “Select Workset” header to open the accordion menu.
<img src="images/select-workset-header.png" alt="red arrow pointing to Select Worksets header in the side menu." width="300"/>
...
<img src="images/my-worksets-selected.png" alt="My Worksets option selected in the worksets dropdown and a personal workset has been selected" width="600"/>
...
<img src="images/create-a-workset-selected.png" alt="Red arrow pointing to the ‘Create a workset’ menu option" width="600"/>
